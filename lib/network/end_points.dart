class EndPoints {
  ...
  static const String PROFILE = '$_api/account/profile';
  static const String PREFERENCES = '$_api/account/preferences';
  static const String DEVICES = '$_api/account/devices';
  static const String DELETE_ACCOUNT = '$_api/account';
  ...
  static const String FEED = '$_api/feed';
  static const String FEED_UNREAD_COUNT = '$_api/feed/unread-count';
  static String feedRead(String recipientId) => '$_api/feed/$recipientId/read';
